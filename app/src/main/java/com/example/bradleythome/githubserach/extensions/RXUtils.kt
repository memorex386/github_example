...
fun CompositeDisposable.delay(delay: Long, unit: TimeUnit = TimeUnit.MILLISECONDS, callback: () -> Unit) = add(com.example.bradleythome.githubserach.extensions.delay(delay, unit, callback))
